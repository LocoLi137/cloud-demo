...
public class PayController
{
    ...
    public String getInfoByConsul(@Value("${loco.info}") String locoInfo)
    {
        return "locoInfo: "+locoInfo+"\t"+"port: "+port;
    }
